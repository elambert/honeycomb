 ...
 *
 * $Id: multi.h 5516 2005-08-31 20:56:48Z sarnoud $
 ***************************************************************************/
/*
...
/*
 * Name:    curl_hc_fd_isset(CURL *easy_handle, fd_set *fds, int* set)
 *
 * Desc:    Honeycomb addition for checking if an easy handle's fd is set
 *
 * Returns: CURLMcode type, general multi error code.
 */
