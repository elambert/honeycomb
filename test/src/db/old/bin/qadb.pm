...
{
  my ($test, $pass, $start_time, $end_time, $build, $performer, $proc_retval, $logs_url, $notes) = @_ ;
...
(test, pass, start_time, end_time, build, performer, proc_retval, logs_url, notes)
values 
(${test}, ${pass}, ${start_time}, ${end_time}, ${build}, ${performer}, ${proc_retval}, ${logs_url}, ${notes})
EOF
;
...
{
  my ($result_id, $test, $pass, $start_time, $end_time, $build, $performer, $proc_retval, $logs_url, $defects_ref) = @_ ;
...
sub test_result_query($$$)
{
  ...
  my $select = "select t.id, t.test, t.pass, t.start_time, t.end_time, t.build, t.performer, t.proc_retval, t.logs_url from test_result t";
